...
<head>
    <meta charset="utf-8" />
    <title>Puskesmas Srikaton</title>
        ...
        <div class="login login-with-news-feed">
            ...
            <div class="news-feed">
                <div class="news-image">
                    <img src="assets/img/login-bg/srikaton.jpeg" data-id="login-cover-image" alt="" style="width: 150%; height: 100%;" />
                </div>
                <div class="news-caption">
                    <h4 class="caption-title"><i class="fa fa-diamond text-success"></i> Puskesmas Srikaton</h4>
                    <p>
                        Alamat
                    </p>
                </div>
            ...
            <div class="right-content">
                ...
                <div class="login-header">
                    <div class="brand">
                        <span class="logo"></span> Payment App
                    </div>
                    <div class="icon">
                ...
                <div class="login-content">
                    <form action="model/aksi_login.php" method="POST" class="margin-bottom-0">
                        ...
                        <div class="login-buttons">
                            <button type="submit" name="simpan" class="btn btn-success btn-block btn-lg">Masuk</button>
                        </div>
                        <hr />
