                ...
                <div class="panel-body">
                    <table id="data-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            $halaman = "index.php?p=absen_bendahara";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href='index.php?p=edit_absen_bendahara&&id=<?php echo $data['id']; ?>' class="btn btn-default btn-icon btn-sm" title='Edit'><i class="fa fa-expand"></i></i></a>
