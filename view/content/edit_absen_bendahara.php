        ...
        <div class="col-md-6">
            <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                ...
                <div class="panel-body panel-form">
                    ...
                    $tampil1 = mysqli_query($conn, $sqli);
                    while ($data = mysqli_fetch_array($tampil1)) {
                    ?>
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" name="absen" action="./model/update_absen_bendahara.php" method="POST">
