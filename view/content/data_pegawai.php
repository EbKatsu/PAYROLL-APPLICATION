                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <select name="id_jabatan" data-live-search="true" data-style="btn-white" class="form-control selectpicker">
                                    ...
                                    $sql = mysqli_query($conn, "SELECT * FROM t_jabatan ORDER BY nama_jabatan ASC");
                ...
                <div class="panel-body">
                    ...
                    <table id="data-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            $i = 0;
                            $sql = mysqli_query($conn, "SELECT * FROM `t_pegawai` INNER JOIN t_jabatan ON t_pegawai.id_jabatan=t_jabatan.id_jabatan ORDER BY nama_pegawai ASC");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a data-nip="<?php echo $data['nip']; ?>" data-halaman="<?php echo $halaman ?>" data-action="<?php echo $action ?>" class="btn btn-danger btn-icon btn-sm delete"><i class="fa fa-trash"></i>
                                    </td>
                                </tr>
                            <?php
                            }
