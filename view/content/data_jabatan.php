                ...
                <div class="panel-body">
                    <table id="data-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            $i = 0;
                            $sql = mysqli_query($conn, "select * from t_jabatan");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <a data-nip="<?php echo $nip; ?>" data-halaman="<?php echo $halaman ?>" data-action="<?php echo $action ?>" class="btn btn-danger btn-icon btn-sm delete"><i class="fa fa-trash"></i>
                                    </td>
                                </tr>
                            <?php
                            }
