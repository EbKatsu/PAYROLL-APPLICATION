        ...
        <div id="header" class="header navbar navbar-default navbar-fixed-top">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <a href="index.php" class="navbar-brand"><span class="navbar-logo"></span> Payment App</a>
            ...
            <div data-scrollbar="true" data-height="100%">
                ...
                <ul class="nav">
                    ...
                    <li class="has-sub active">
                        ...
                        <ul class="sub-menu">
                            <li><a href="index.php?p=profil_bendahara&&username=<?php echo $_SESSION['username']; ?>"> Profil</a></li>
                        </ul>
                    </li>
                    <li class="has-sub active">
                        <a href="javascript:;">
                        ...
                        <ul class="sub-menu active">
                            <li><a href="index.php?p=absen_bendahara">Absen</a></li>
                            <li><a href="index.php?p=data_gaji_bendahara">Gaji</a></li>
                        </ul>
                    </li>
