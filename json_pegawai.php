...
$tampil=mysqli_query($conn, "SELECT * from t_pegawai inner join t_jabatan on t_pegawai.id_jabatan=t_jabatan.id_jabatan JOIN t_absen on t_pegawai.nip = t_absen.nip and t_pegawai.nip='$_POST[nip]' WHERE t_absen.bulan='$_POST[bulan]' AND t_absen.tahun='$_POST[tahun]'");
